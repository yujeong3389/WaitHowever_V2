...
// import S from './style';
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
// import { faShield, faHammer, faScaleBalanced, faFlag  } from '@fortawesome/free-solid-svg-icons'; // 사용할 아이콘 임포트
// import ReactMarkdown from 'react-markdown';
...
//         .replace(/\*\*policy\*\*:\s*(보수|중도|진보)\n?/i, '')
//         .replace(/\*\*agitation\*\*:\s*\d+\n?/i, '')
//         .replace(/\*\*keyword\*\*:\s*[^\n]+\n?/i, '');

//     console.log(content);
//     return { policy, agitation, keyword, content };
// };
...
//     const { policy, agitation, keyword, content } = extractValues(response);

//     const policyIcon = {
//         보수: <FontAwesomeIcon icon={faShield} />,        // 방패 아이콘
//         중도: <FontAwesomeIcon icon={faScaleBalanced} /> ,    // 저울 아이콘
//         진보: <FontAwesomeIcon icon={faHammer} />            // 망치 아이콘
//     };

//     // zai_agitation에 따른 아이콘 색상 설정
//     const agitationColor = {
//         1: "teal",
//         2: "indigo",
//         3: "orange",
...
//                             <S.IconContainer>
//                                 <S.TendencyContainer>
//                                     <div>{policyIcon[policy]}</div> {/* 조건에 맞는 아이콘 표시 */}
...
//                             <S.IconContainer>
//                                 <S.AgitationContainer color={agitationColor[agitation]}>
//                                     <FontAwesomeIcon icon={faFlag} /> {/* 깃발 아이콘 */}
